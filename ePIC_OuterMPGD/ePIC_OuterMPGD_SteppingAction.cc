...
*   
*   	FileName：		ePIC_OuterMPGD_SteppingAction.cc
...
ePIC_OuterMPGD_SteppingAction::ePIC_OuterMPGD_SteppingAction(ePIC_OuterMPGD_Detector* detector)
...
ePIC_OuterMPGD_SteppingAction::~ePIC_OuterMPGD_SteppingAction(){
...
bool ePIC_OuterMPGD_SteppingAction::UserSteppingAction(const G4Step* aStep, bool was_used){
...
void ePIC_OuterMPGD_SteppingAction::SetInterfacePointers(PHCompositeNode* topNode){
	...
	if(!m_HitContainer){
		std::cout<< "ePIC_OuterMPGD_SteppingAction::SetTopNode - unable to find " << hitnodename << std::endl;
	}
}
