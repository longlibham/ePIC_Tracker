...
*   
*   	FileName：		ePIC_TOFBarrel_SteppingAction.cc
...
ePIC_TOFBarrel_SteppingAction::ePIC_TOFBarrel_SteppingAction(ePIC_TOFBarrel_Detector* detector)
...
ePIC_TOFBarrel_SteppingAction::~ePIC_TOFBarrel_SteppingAction(){
...
bool ePIC_TOFBarrel_SteppingAction::UserSteppingAction(const G4Step* aStep, bool was_used){
...
void ePIC_TOFBarrel_SteppingAction::SetInterfacePointers(PHCompositeNode* topNode){
	...
	if(!m_HitContainer){
		std::cout<< "ePIC_TOFBarrel_SteppingAction::SetTopNode - unable to find " << hitnodename << std::endl;
	}
}
