...
if __name__ == '__main__':
    ...
    parser.add_argument('--emin', type=float, default=-0.88, help='start of the eta range')
    parser.add_argument('--emax', type=float, default=0.88, help='stop of the eta range')
