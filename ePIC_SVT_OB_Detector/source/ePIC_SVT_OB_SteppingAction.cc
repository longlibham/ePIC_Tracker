...
*   
*   	FileName：		ePIC_SVT_OB_SteppingAction.cc
...
ePIC_SVT_OB_SteppingAction::ePIC_SVT_OB_SteppingAction(ePIC_SVT_OB_Detector* detector)
...
ePIC_SVT_OB_SteppingAction::~ePIC_SVT_OB_SteppingAction(){
...
void ePIC_SVT_OB_SteppingAction::SetInterfacePointers(PHCompositeNode* topNode){
	...
	if(!m_HitContainer){
		std::cout<< "ePIC_SVT_OB_SteppingAction::SetTopNode - unable to find " << hitnodename << std::endl;
	}
}
