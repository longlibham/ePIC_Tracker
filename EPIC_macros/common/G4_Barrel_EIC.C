...
void Barrel(PHG4Reco *g4Reco, int det_ver = 3)
{
  ...
  //---------------------------
  // Vertexing
  double si_vtx_r_pos[] = {3.6, 4.8, 12.0};
...
//    cyl->SuperDetector("SVTX");  breakout SVTX into individual layers
  ...
  double z_e_length[] = {-27, -42.0};
  double z_h_length[] = {27, 42.0};
  // double z_e_length[] = {-27.0, -52.0};
  // double z_h_length[] = {27.0, 52.0};
  double si_r_pos[] = {27., 42.00};
  // double si_r_pos[] = {21.0, 40.00}; // Modified to have 27cm staves
