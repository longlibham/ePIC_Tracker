...
double TrackingService(PHG4Reco *g4Reco, double radius)
{
  ...
  double CuThickness = 0.;          // 0.0 cms
  double AlThickness = 1.124;           // 0.1 cms
  double WaterThickness = 0.;      // 0.0 cms
  double PlasticThickness = 0.;    // 0.0 cms
  double CarbonThickness = 0.67;  // 0.2 cms
  ...
  // disconuity introduced to avoid overlaps with MPGD-DIRC: r=68 -> 65cm
  cones.push_back(new ServiceProperties("ETrackingCone_Disk4TouRwell", CuThickness, 5*AlThickness, WaterThickness, PlasticThickness, CarbonThickness, 0, -147.47, -90, 65, 44.));
  ...
  cylinders.push_back(new ServiceProperties("ETrackingCyl_uRWellPlateau", CuThickness, 5*AlThickness, WaterThickness, PlasticThickness, CarbonThickness, 0, -90, -44., 44., 0));
  ...
  cones.push_back(new ServiceProperties("ETrackingCone_uRwellToVertex", CuThickness, 2*AlThickness, WaterThickness, PlasticThickness, CarbonThickness, 0, -44., -13.5, 44., 13.5));
  ...
  cones.push_back(new ServiceProperties("EVertexSupportRing", CuThickness, 2*AlThickness, WaterThickness, PlasticThickness, CarbonThickness, 0, -13.68, -13.69, 3.6, 13.5));
  cylinders.push_back(new ServiceProperties("BTrackingCyl_Vertex", 0, 0, 0, 0, 0.036, 0, -13.5, 13.5, 13.5, 0));
  cones.push_back(new ServiceProperties("HVertexSupportRing", CuThickness, 2*AlThickness, WaterThickness, PlasticThickness, CarbonThickness, 0, 13.68, 13.69, 3.6, 13.5));
  ...
  cones.push_back(new ServiceProperties("HTrackingCone_VertexTouRwell", CuThickness, 2*AlThickness, WaterThickness, PlasticThickness, CarbonThickness, 0, 13.5, 44., 13.5, 44.));

  // Cylinder service to rest the uRwell in H region Plateau
  cylinders.push_back(new ServiceProperties("HTrackingRWellPlateau", CuThickness, 4*AlThickness, WaterThickness, PlasticThickness, CarbonThickness, 0, 44., 103.75, 44., 0));
  ...
  cones.push_back(new ServiceProperties("HTrackingCone_uRwellToDisk5", CuThickness, 5*AlThickness, WaterThickness, PlasticThickness, CarbonThickness, 0, 103.75, 173, 44., 69.2));
