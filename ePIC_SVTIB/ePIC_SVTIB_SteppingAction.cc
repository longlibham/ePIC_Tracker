...
*   
*   	FileName：		ePIC_SVTIB_SteppingAction.cc
...
ePIC_SVTIB_SteppingAction::ePIC_SVTIB_SteppingAction(ePIC_SVTIB_Detector* detector)
...
ePIC_SVTIB_SteppingAction::~ePIC_SVTIB_SteppingAction(){
...
bool ePIC_SVTIB_SteppingAction::UserSteppingAction(const G4Step* aStep, bool was_used){
...
void ePIC_SVTIB_SteppingAction::SetInterfacePointers(PHCompositeNode* topNode){
	...
	if(!m_HitContainer){
		std::cout<< "ePIC_SVTIB_SteppingAction::SetTopNode - unable to find " << hitnodename << std::endl;
	}
}
